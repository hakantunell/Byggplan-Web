...
type DrawingAngle={id:string;center:DrawingPoint;a:DrawingPoint;b:DrawingPoint;label:string;description?:string;visible:boolean;labelOffset?:DrawingPoint;arcRadius?:number};
