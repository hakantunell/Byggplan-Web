...
export function ProjectDocumentsBar(){
  ...
  useEffect(()=>{void (async()=>{try{const r=await fetch(`${API_BASE}/api/projects`);const d=await r.json() as {projects?:Project[]};setProjects(d.projects||[]);}catch{setProjects([])}})()},[]);
