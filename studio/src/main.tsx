...
import { ProjectBackupSettingsMount } from './ProjectBackupSettingsMount';
...
ReactDOM.createRoot(document.getElementById('root')!).render(<React.StrictMode><AuthGate><StudioShell/><ProjectInformationMount/><ProjectBackupSettingsMount/><MasterV2UpgradeAction/></AuthGate></React.StrictMode>);
