...
ReactDOM.createRoot(document.getElementById('root')!).render(<React.StrictMode><AuthGate><StudioShell/><ProjectInformationMount/><SystemBackupSettingsMount/><MasterV2UpgradeAction/></AuthGate></React.StrictMode>);
