...
import {ControlPlanPdfActionMount} from './ControlPlanPdfActionMount';
...
export function ProjectReportsMount({projectId}:{projectId:string}){
 ...
 return createPortal(<><GoverningReportsView projectId={projectId}/><ControlPlanPdfActionMount projectId={projectId}/></>,target);
}
